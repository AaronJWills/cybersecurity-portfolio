...
## Overview
Learning how to use Tcpdump to save, filter, and display packets.

## Key Skills Practised
- Capturing packets and save them to a file
- Setting filters on captured packets
- Controlling how captured packets are displayed
...
- You can count lines by piping the output via the wc command
...
- tcp[tcpflags] to refer to the TCP flags field. The following TCP flags are available to compare with:
...
Along with Wireshark and Tshark, Tcpdump is an excellent tool for better understanding networking protocols.
